  ...
  ra: {
    ...
    input: {
      file: {
        ...
        upload_single:
          "Arrastra un archivo para cargarlo, o haz click para seleccionarlo.",
      },
      image: {
        upload_several:
      ...
      references: {
        ...
        single_missing: "La reference asociada ya no parece estar disponible.",
      },
      password: {
    ...
    message: {
      ...
      details: "Detalles",
      error: "Ocurrió un error de cliente y la acción no pudo ser completada.",

      invalid_form:
        "El formulario no es válida. Por favor revisa si hay errores",
    ...
    configurable: {
      ...
      inspector: {
        title: "Inspector",
        content:
          "Pasar el cursos sobre los elementos UI de la applicación para configurarlos",
